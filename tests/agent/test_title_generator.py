...
class TestAutoTitleSession:
    ...
    def test_uniquifies_duplicate_generated_title_before_callback(self):
        """Generated titles must be made unique before propagating callbacks."""
        db = MagicMock()
        db.get_session_title.return_value = None
        db.get_session_title_source = None
        # Exercise the legacy store compatibility lane explicitly. An
        # unconstrained MagicMock manufactures a truthy ``set_auto_title``
        # attribute even though this fixture is testing set_auto_title_if_empty.
        db.set_auto_title = None
