...
def test_quickstart_runs_all_three_legs(client, recommended_machine, monkeypatch, tmp_path):
...
def test_quickstart_skips_satisfied_legs(client, recommended_machine, monkeypatch):
