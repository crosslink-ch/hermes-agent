...
_TOOL_STUBS = {
    ...
    "read_file": (
        "read_file",
        "path: str, offset: int = 1, limit: int = 500, target: str = None, runtime_scope: str = None",
...
def _frozen_target_config(resolution) -> dict:
    """Build a resolver snapshot without changing selected-target defaultness."""
    targets = {
        resolution.target: deepcopy(dict(resolution.config)),
    }
...
_TOOL_DOC_LINES = [
    ...
    ("read_file",
     "  read_file(path: str, offset: int = 1, limit: int = 500, target: str = None, runtime_scope: str = None) -> dict\n"
