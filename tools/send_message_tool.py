...
from tools.send_message_thechat import _send_thechat, _send_thechat_media
...
_TEXT_SENDERS = {
    "thechat": lambda pc, cid, chunk, tid: _send_thechat(pc, cid, chunk, thread_id=tid),
...
_MEDIA_PLATFORMS_NOTE = "telegram, discord, matrix, weixin, signal, yuanbao, feishu, whatsapp, slack and thechat"
