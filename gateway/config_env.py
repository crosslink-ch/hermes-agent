...
_ENV_ENABLE_CREDENTIALS: dict = {
    ...
    Platform.THECHAT: ("THECHAT_BASE_URL", "THECHAT_BOT_TOKEN"),
...
_ENV_STEPS: tuple = (
    ...
    _Cred(Platform.THECHAT, ("THECHAT_BASE_URL", "THECHAT_BOT_TOKEN"), token="THECHAT_BOT_TOKEN",
          fixed=(("base_url", "THECHAT_BASE_URL", "", lambda v: v.strip().rstrip("/")),),
          optional=(("poll_interval", "THECHAT_POLL_INTERVAL", float),
                    ("webhook_host", "THECHAT_WEBHOOK_HOST"),
                    ("webhook_port", "THECHAT_WEBHOOK_PORT", _INT),
                    ("webhook_path", "THECHAT_WEBHOOK_PATH"),
                    ("webhook_url", "THECHAT_WEBHOOK_URL")), home="THECHAT_HOME_CHANNEL"),
