...
class TurnContext:
    ...
    # --- structured activity rail (currently implemented by TheChat) -----
    _structured_progress_adapter: Any = None
    _structured_progress_supported: bool = False
    _structured_completion_meta: dict[str, list[dict[str, Any]]] = field(
