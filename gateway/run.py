...
_BUILTIN_ADAPTERS: dict[Platform, tuple[str, str, str, str]] = {
    Platform.THECHAT: ("thechat", "TheChatAdapter", "check_thechat_requirements", "TheChat: httpx not installed"),
...
from gateway.run_thechat import GatewayTheChatMixin


class GatewayRunner(GatewayTheChatMixin,
