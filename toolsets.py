...
TOOLSETS = {
    ...
    "hermes-thechat": {
        "description": "TheChat bot toolset - workspace chat through TheChat platform adapter",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
