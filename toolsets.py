...
TOOLSETS = {
    ...
    "hermes-thechat": _bundle("TheChat bot toolset - workspace chat through TheChat platform adapter"),
    ...
    "hermes-gateway": _ts(
        ...
        [],
        includes=[
            "hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-thechat",
