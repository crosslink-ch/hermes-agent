...
def auto_title_session(
    ...
    try:
        ...
        # Keep operator-visible failures, session attribution and upstream callback.
        logger.warning("Auto-title failed for session %s (harmless; if this started after an update, restart the running Hermes process): %s", session_id, e)
