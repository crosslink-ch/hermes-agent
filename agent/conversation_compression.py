...
def compress_context(
    ...
    *,
    ...
    try:
        ...
        if todo_snapshot:
            # Retention parity (#84718): if this boundary pruned skill bodies,
            # keep the reload requirement next to the internal todo continuity
            # note.  The fork deliberately represents this state as assistant
            # bookkeeping, never as a synthetic user instruction.
