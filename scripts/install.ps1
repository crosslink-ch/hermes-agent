        ...
        if ($browserNpmOk) {
            ...
            if (-not $npxExe) {
                ...
                try {
                    ...
                    # #39219.
                    $ErrorActionPreference = "Continue"
                    $pwCode = _Invoke-NativeWithTimeout $npxExe "--yes agent-browser install" `
                    ...
                    if ($pwCode -eq 0) {
                        ...
                        Write-Warn "agent-browser Chrome install timed out after $([math]::Round($nodeDepsTimeoutSec / 60)) minutes."
