...
const RELEASE_NOTES_URL = 'https://github.com/crosslink-ch/hermes-agent/releases'
const INSTALLER_URL = 'https://github.com/crosslink-ch/hermes-agent#installation'
