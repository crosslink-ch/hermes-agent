 ...
 *
 * A public install can end up with `origin=git@github.com:crosslink-ch/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/crosslink-ch/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/crosslink-ch/hermes-agent'
